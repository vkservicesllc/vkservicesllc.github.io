  ...
  CL:
    {
      ...
      month1_cards: {
        ...
        user1:     [1, '1995296890'],
        user2:     [1, '2117669368'],
        month_key: ['Jul', '1lrJ8BxtFLX0ZE25_QHzMO2_z2eNcxJuj5Lhf1oOiX84']
      },
      month2_cards: {
        user0:     [1, '686342087'],
        user1:     [1, '1995296890'],
      ...
      month1_codes: {
        ...
        month_key: ['Jul', '1KqLgcvq73_x7o-o6FkzFHDCq2pYjp2CADcLTxM8wW6s']
      },
      month2_codes: {
        user0:     [1, '1165085359', '1782605551'],
  ...
  CT:
    {
      ...
      month1_cards: {
        ...
        user1:     [0, '1995296890'],
        user2:     [0, '2117669368'],
        month_key: ['Jul', '11nM-M6U08zwyUuZ7N8932rdD69DLgayLrw8gmEtId0U']
      },
      month2_cards: {
        user0:     [1, '686342087'],
        user1:     [1, '1995296890'],
      ...
      month1_codes: {
        user0:     [1, '1165085359', '1782605551'],
        month_key: ['Jul', '1qIwoRG06fUrszjj2sXdxVuG5R-jIz-V--mc5Ni5O5-E']
      },
      month2_codes: {
        user0:     [1, '1165085359', '1782605551'],
  ...
  DE:
    {
      ...
      month1_cards: {
        ...
        user1:     [0, '1995296890'],
        user2:     [0, '2117669368'],
        month_key: ['Jul', '1q-YEOzZTjm4QVFfTao_B7DEd0DjrqkBJVUNoSp0bwG4']
      },
      month2_cards: {
        user0:     [1, '686342087'],
        user1:     [1, '1995296890'],
